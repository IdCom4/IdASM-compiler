package com.idcom4.compiler.tokens.value_tokens;
...
import com.idcom4.compiler.tokens.value_tokens.custom_values.CustomValueToken;
...
public abstract class ValueToken extends Token {
    ...
    public static class Parser {
        ...
        private static final ITokenParser<?>[] parsers = new ITokenParser[] {
                ...
                CustomValueToken.Parser::TryParse,
        };

        public static ParsingResult<ValueToken> TryParse(String sourceCode, int index) throws TokenParsingException {
            ...
            for (ITokenParser<?> parser : parsers) {
                try {
                    ...
                    return new ParsingResult<>((ValueToken) result.token(), result.newIndex());
