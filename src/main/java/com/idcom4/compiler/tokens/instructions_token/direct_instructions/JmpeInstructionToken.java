...
public class JmpeInstructionToken extends JmpInstructionToken {

    public static final String name = IdASMCompiler.EKeywords.JMPE.value;
    public static final short opcode = (short) 0x10;

    public static class Parser {

        public static ParsingResult<JmpeInstructionToken> TryParse(String sourceCode, int index) throws CompilationException {
            ...
            return new ParsingResult<>(new JmpeInstructionToken(parsed2Params.param0(), parsed2Params.param1()), parsed2Params.newIndex());
        }
    }

    public JmpeInstructionToken(DirectValueToken param0, DirectValueToken param1) {
