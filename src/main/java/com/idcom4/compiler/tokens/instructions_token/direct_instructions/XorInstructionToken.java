...
public class XorInstructionToken extends TwoParamsDirectInstructionToken {

    public static final String name = IdASMCompiler.EKeywords.XOR.value;
    public static final short opcode = (short) 0x08;

    public static class Parser {

        public static ParsingResult<XorInstructionToken> TryParse(String sourceCode, int index) throws CompilationException {
            ...
            return new ParsingResult<>(new XorInstructionToken(parsed2Params.param0(), parsed2Params.param1()), parsed2Params.newIndex());
        }
    }

    public XorInstructionToken(DirectValueToken param0, DirectValueToken param1) {
