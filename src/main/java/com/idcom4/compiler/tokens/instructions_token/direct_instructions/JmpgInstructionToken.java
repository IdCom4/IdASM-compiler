...
public class JmpgInstructionToken extends JmpInstructionToken {

    public static final String name = IdASMCompiler.EKeywords.JMPG.value;
    public static final short opcode = (short) 0x13;

    public static class Parser {

        public static ParsingResult<JmpgInstructionToken> TryParse(String sourceCode, int index) throws CompilationException {
            ...
            return new ParsingResult<>(new JmpgInstructionToken(parsed2Params.param0(), parsed2Params.param1()), parsed2Params.newIndex());
        }
    }
    
    public JmpgInstructionToken(DirectValueToken param0, DirectValueToken param1) {
