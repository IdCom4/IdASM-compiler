...
public class SubInstructionToken extends TwoParamsDirectInstructionToken {

    public static final String name = IdASMCompiler.EKeywords.SUB.value;
    public static final short opcode = (short) 0x02;

    public static class Parser {

        public static ParsingResult<SubInstructionToken> TryParse(String sourceCode, int index) throws CompilationException {
            ...
            return new ParsingResult<>(new SubInstructionToken(parsed2Params.param0(), parsed2Params.param1()), parsed2Params.newIndex());
        }
    }

    public SubInstructionToken(DirectValueToken param0, DirectValueToken param1) {
