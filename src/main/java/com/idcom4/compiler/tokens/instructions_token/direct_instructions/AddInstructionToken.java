...
public class AddInstructionToken extends TwoParamsDirectInstructionToken {

    public static final String name = IdASMCompiler.EKeywords.ADD.value;
    public static final short opcode = (short) 0x01;

    public static class Parser {

        public static ParsingResult<AddInstructionToken> TryParse(String sourceCode, int index) throws CompilationException {
            ...
            return new ParsingResult<>(new AddInstructionToken(parsed2Params.param0(), parsed2Params.param1()), parsed2Params.newIndex());
        }
    }

    public AddInstructionToken(DirectValueToken param0, DirectValueToken param1) {
