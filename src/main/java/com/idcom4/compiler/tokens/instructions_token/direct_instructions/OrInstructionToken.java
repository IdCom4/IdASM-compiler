...
public class OrInstructionToken extends TwoParamsDirectInstructionToken {

    public static final String name = IdASMCompiler.EKeywords.OR.value;
    public static final short opcode = (short) 0x07;

    public static class Parser {

        public static ParsingResult<OrInstructionToken> TryParse(String sourceCode, int index) throws CompilationException {
            ...
            return new ParsingResult<>(new OrInstructionToken(parsed2Params.param0(), parsed2Params.param1()), parsed2Params.newIndex());
        }
    }

    public OrInstructionToken(DirectValueToken param0, DirectValueToken param1) {
