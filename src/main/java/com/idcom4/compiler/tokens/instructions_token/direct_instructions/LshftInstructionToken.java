...
public class LshftInstructionToken extends TwoParamsDirectInstructionToken {

    public static final String name = IdASMCompiler.EKeywords.LSHFT.value;
    public static final short opcode = (short) 0x09;

    public static class Parser {

        public static ParsingResult<LshftInstructionToken> TryParse(String sourceCode, int index) throws CompilationException {
            ...
            return new ParsingResult<>(new LshftInstructionToken(parsed2Params.param0(), parsed2Params.param1()), parsed2Params.newIndex());
        }
    }

    public LshftInstructionToken(DirectValueToken param0, DirectValueToken param1) {
