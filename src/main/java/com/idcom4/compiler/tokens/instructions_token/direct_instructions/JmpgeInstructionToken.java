...
public class JmpgeInstructionToken extends JmpInstructionToken {

    public static final String name = IdASMCompiler.EKeywords.JMPGE.value;
    public static final short opcode = (short) 0x14;

    public static class Parser {

        public static ParsingResult<JmpgeInstructionToken> TryParse(String sourceCode, int index) throws CompilationException {
            ...
            return new ParsingResult<>(new JmpgeInstructionToken(parsed2Params.param0(), parsed2Params.param1()), parsed2Params.newIndex());
        }
    }

    public JmpgeInstructionToken(DirectValueToken param0, DirectValueToken param1) {
