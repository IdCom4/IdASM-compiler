...
public class DivInstructionToken extends TwoParamsDirectInstructionToken {

    public static final String name = IdASMCompiler.EKeywords.DIV.value;
    public static final short opcode = (short) 0x03;

    public static class Parser {

        public static ParsingResult<DivInstructionToken> TryParse(String sourceCode, int index) throws CompilationException {
            ...
            return new ParsingResult<>(new DivInstructionToken(parsed2Params.param0(), parsed2Params.param1()), parsed2Params.newIndex());
        }
    }

    public DivInstructionToken(DirectValueToken param0, DirectValueToken param1) {
