...
public class ModInstructionToken extends TwoParamsDirectInstructionToken {

    public static final String name = IdASMCompiler.EKeywords.MOD.value;
    public static final short opcode = (short) 0x05;

    public static class Parser {

        public static ParsingResult<ModInstructionToken> TryParse(String sourceCode, int index) throws CompilationException {
            ...
            return new ParsingResult<>(new ModInstructionToken(parsed2Params.param0(), parsed2Params.param1()), parsed2Params.newIndex());
        }
    }

    public ModInstructionToken(DirectValueToken param0, DirectValueToken param1) {
